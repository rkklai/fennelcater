...
//    var ref = new Firebase('https://fennelcater.firebaseio.com/ingredients');
 $scope.mockIngredients = [
    {name: 'Carlos  Flowers', unit: 'lb', price: 11},
    {name: 'Byron Taylor', unit: 'lb', price: 11}
  ];
